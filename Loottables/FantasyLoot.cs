    ...
    public class FantasyLoot : Loottable
    {
        public FantasyLoot() {
            Loot = new List<Equipment>{
                ...
                new Equipment("Moonblade", 5, 20, 0, 0),
                new Equipment("Berserker Axe", 4, 10, 0, 0),
                ...
                new Equipment("Elven Bow", 3, 10, 0, 0),
                ...
                new Equipment("Wooden Dagger", 1, 10, 0, 0),
                new Equipment("Wand of Fireballs", 5, 10, 0, 0),
                new Equipment("Wand of Fireballs", 5, 10, 0, 0),
